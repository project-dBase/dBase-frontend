...
import iAmANode  from "@/pages/custom/iAmANode.vue";
import dBaseFalcest  from "@/pages/custom/dBaseFalcest.vue";
import Test  from "@/pages/custom/test.vue";

import Breadcrumb from "../pages/advance/breadcrumbs/breadCrumb.vue";

import Sticky from "../pages/advance/sticky/stickyView.vue";
import Home from '../pages/custom/index.vue';

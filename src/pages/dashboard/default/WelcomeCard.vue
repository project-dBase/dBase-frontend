            ...
            <div class="media">
                <div class="media-body">
                    <div class="greeting-user">
                        <h6 class="f-w-600 mb-0">Become dBase and earn</h6>
                        <p>Each node will be paid with Dbase tokens. Start and earn money</p>
                        <div class="whatsnew-btn">
                            <a class="btn btn-outline-white">Became node!</a>
                        </div>
                    </div>
                </div>
                <div>
